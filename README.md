...
I am a Data Scientist with a strong background in Software Engineering and Full-Stack Development. With a Master's Degree from USC (Fight On!) and extensive professional experience in data science, software engineering, research, and entrepreneurship, I bring a unique blend of technical expertise and strategic thinking to solve complex data-driven problems. Let's connect and explore opportunities to collaborate!

Since October 2024, I've worked as a Product Software Engineer at Glean, an Enterprise AI company, where I'm laser-focused on one key metric: **time-to-value** for new customers adopting our search and agent tooling. As part of the Glean Workspace team over the past 6 months, I've worked across the entire stack—backend, frontend, and data science—to dramatically improve the customer onboarding experience. Through streamlining configuration processes, building comprehensive audit logging for administrators, and enhancing employee directory integration with intuitive mapping previews, I've driven down **time-to-first-search by 55%** and **reduced customer escalations by 25%**. My work centers on removing friction from the path between customer deployment and realizing tangible value from Glean's AI-powered workplace search capabilities.
...
| ----- | ------- | --------- |
| **Software Engineer, Product** | Glean | October 2024 - Present |
